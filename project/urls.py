...
from divaGui.views import collection, ContactTemplateView, CollectionsView, AddCollectionView, DeleteCollectionView, TryoutsTemplateView
...
urlpatterns = [
    ...
    url(r'^addnewcollection/$', AddCollectionView.as_view()),
